...
if($_POST){
    ...
    $sql = "UPDATE `proyectos` SET `nombre` = '$nombre_proyecto' , `descripcion` = '$descripcion', $agregaimagen `link` = '$link'  WHERE `proyectos`.`id` = '$id';";
...
<h1 class="display-3">Modificar Proyecto</h1>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div class="d-flex justify-content-center align-item-center">
                                        <img class="img__modificar" width="500" src="images/<?php echo $fila['imagen']; ?>">
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <input required class="form-control" type="text" name="link" id="link" value="<?php echo $fila['link']; ?>">
                            </div>
                            <br>
                            <div>
