<?php include '_header.php';
    ...
    $sql="INSERT INTO `proyectos` (`id`, `nombre`, `descripcion`, `imagen`, `link`, `visibilidad`) VALUES (NULL, '$nombre_proyecto' , '$descripcion', '$imagen', '$link', 'SI')";
 ...
 if($_GET){
   ...
   if(isset($_GET['modificar'])){
    ...
    if(isset($_GET['visibilidad'])){
        $id = $_GET['visibilidad'];
        header("Location:visibilidad.php?visibilidad=".$id);
        die();
    }
 } 
...
<title>Editor de Portfolio</title>
</head>
<body>
<?php include '_menu.php';?>

<h1 class="display-3">Editor de Portfolio</h1>
        ...
        <div class="col-md-10 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="edit_galeria.php" method="post" enctype="multipart/form-data">
                        <div>
                        ...
                        <br>
                        <div>
                            <label for="nombre">Link al Proyecto</label>
                ...
                <table class="table">
                    ...
                    <tbody >
                        ...
                        <tr >
                            ...
                            <td> <img width="200" src="images/<?php echo $proyecto['imagen'];?>" alt="">  </td>
                            <td class="texto"><a href="<?php echo $proyecto['link'];?>" target="_blank" >Link</a>  </td>
                            ...
                            <td><a name="visibilidad" id="visibilidad" class="btn btn-primary" href="?visibilidad=<?php echo $proyecto['id'];?>">
                                <?php
                                    if($proyecto['visibilidad']=="SI"){
                                        echo "Ocultar";
                                    }else{
                                        echo "Mostrar";
                                    }                                
                 ...
                 foreach($proyectos as $proyecto){ ?>
                    <div class="col card__mobile  mb-4">
                        <div class="card border border-3 shadow w-100">
                            ...
                            <a>
                                <img class="card-img-top" width="200" src="images/<?php echo $proyecto['imagen'];?>" alt="">
                            </a>
                            <div class="card-body">
                                ...
                                <a name="visibilidad" id="visibilidad" class="btn btn-primary" href="?visibilidad=<?php echo $proyecto['id'];?>">
                                <?php
                                    if($proyecto['visibilidad']=="SI"){
                                        echo "Ocultar";
                                    }else{
